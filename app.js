// --- APP VERSION ---
const APP_VERSION = '2026.05.07.07';
...
window.onload = function() {
    ...
    // 版本檢查（延遲2分鐘，避免 Cloudflare 快取差異誤報）
    setTimeout(() => {
        checkForUpdates();
...
async function checkForUpdates() {
    if (versionToastShown) return; // 已通知過就不再檢查
    try {
        ...
        if (match) {
            ...
            if (isNewerVersion(remoteVersion, PAGE_LOAD_VERSION)) {
...
function formatBibleResult(parsed) {
