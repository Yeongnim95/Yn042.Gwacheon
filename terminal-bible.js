...
const TEXT = {
    zh: {
        ...
        npmLabel: 'npm 安裝',
        releaseNote: '@scoynim/bible 0.1.1 已正式發布，複製排版已與網站一致，可使用上方一行指令或 npm 直接安裝。',
        copySection: '複製經文',
        readSection: '查看整章',
        otherSection: '查詢與說明',
        formatTitle: '顯示格式',
    ...
    ko: {
        ...
        npmLabel: 'npm 설치',
        releaseNote: '@scoynim/bible 0.1.1이 정식 배포되었으며 복사 형식이 웹사이트와 동일합니다. 위의 한 줄 명령어나 npm으로 바로 설치할 수 있습니다.',
