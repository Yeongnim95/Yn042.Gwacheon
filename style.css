:root {
    ...
    --text-muted: #999;
    --border-light: #d5cfc5;
    --border-lighter: #e0dbd3;
    --border-lightest: #eae5dd;
    --shadow-color: rgba(80, 60, 40, 0.08);
    --input-bg: #faf8f4;
    --nav-bg: #ece7df;
}
...
body {
    font-family: "Noto Sans KR", "Noto Sans TC",
                 "Apple SD Gothic Neo", "Malgun Gothic", "Microsoft JhengHei",
...
.menu-category-title.home-link {
    background: var(--light-green-bg);
}
.menu-category-title.home-link:hover {
    background: var(--primary-green);
    color: white;
}
.menu-category-title.disabled {
    color: #999;
    cursor: not-allowed;
}
.menu-category-title.disabled:hover {
    background: transparent;
}
.dev-badge {
    font-size: 0.65rem;
...
.nav-ai-btn:hover { background: var(--bg-secondary); }
.nav-ai-text {
    font-size: 0.75rem;
    font-weight: 700;
    color: var(--primary-green);
...
.nav-ai-btn svg { color: var(--text-secondary); display: block; }

/* 首頁時AI按鈕白色 */
body.home-active .nav-ai-btn {
    border-color: rgba(255,255,255,0.3) !important;
    background: rgba(255,255,255,0.15) !important;
}
body.home-active .nav-ai-text { color: white !important; }
body.home-active .nav-ai-btn svg { color: white !important; }
...
.ai-panel-overlay.show { opacity: 1; visibility: visible; }
...
.ai-panel-close:hover { background: var(--bg-secondary); }
...
.ai-panel-input:focus { border-color: var(--primary-green); }
.ai-panel-input::placeholder { color: var(--text-muted); font-size: 12px; }
...
.ai-panel-send:hover { filter: brightness(1.1); }
.ai-panel-send:disabled { opacity: 0.4; }

.ai-panel-note { margin-top: 10px; }

.ai-panel-result {
    margin-top: 12px;
}

.ai-panel-result-item {
    padding: 12px;
    border-radius: 10px;
    margin-bottom: 10px;
    font-size: 13px;
...
.ai-panel-result-item.success {
    background: rgba(67,160,71,0.08);
    border: 1px solid rgba(67,160,71,0.15);
}
.ai-panel-result-item.error {
    background: rgba(229,57,53,0.08);
    border: 1px solid rgba(229,57,53,0.15);
    color: var(--danger-red);
}
.ai-panel-result-item .result-query {
    font-weight: 600;
    color: var(--primary-green);
    margin-bottom: 6px;
}
.ai-panel-result-item .result-text {
...
.ai-panel-result-item .result-copied {
    margin-top: 6px;
    font-size: 11px;
    color: var(--primary-green);
    font-weight: 600;
}
.ai-panel-result-item .result-time {
    font-size: 10px;
    color: var(--text-muted);
    margin-top: 4px;
}
...
.ai-panel-loading::after {
    ...
    border-radius: 50%;
    animation: smartSpin 0.6s linear infinite;
    margin-left: 8px;
...
.version-update-btn:hover { filter: brightness(1.1); }
...
#homeSection.page-section {
    padding: 0 !important;
    margin: 0 !important;
}

/* 首頁投影片式滾動容器 */
#homeSection .home-container {
    margin-top: -60px;
...
body.home-active nav .nav-title {
    color: white !important;
    text-shadow: 0 1px 3px rgba(0,0,0,0.4);
}

body.home-active nav .menu-toggle {
    background: rgba(255,255,255,0.15) !important;
    color: white !important;
}

body.home-active nav .menu-toggle:hover {
    background: rgba(255,255,255,0.25) !important;
}

body.home-active nav .hamburger-icon,
body.home-active nav #current-page-title,
body.home-active nav .dropdown-arrow {
    color: white !important;
    text-shadow: 0 1px 3px rgba(0,0,0,0.4);
}

body.home-active nav .lang-select {
    color: white !important;
    background: rgba(255,255,255,0.15) !important;
    border-color: rgba(255,255,255,0.3) !important;
}

body.home-active nav .lang-select option {
    color: #333;
    background: #f5f0e8;
}

/* 首頁選單霧面玻璃效果 */
body.home-active .menu-dropdown {
...
body.home-active .menu-category-title { color: rgba(255,255,255,0.9) !important; }
body.home-active .menu-category-title:hover { background: rgba(255,255,255,0.1) !important; }
body.home-active .menu-category-title.home-link { background: rgba(255,255,255,0.08) !important; }
body.home-active .menu-category-title.home-link:hover { background: rgba(255,255,255,0.2) !important; color: white !important; }
body.home-active .menu-category { border-bottom-color: rgba(255,255,255,0.1) !important; }
body.home-active .menu-btn { color: rgba(255,255,255,0.85) !important; }
body.home-active .menu-btn:hover { background: rgba(255,255,255,0.12) !important; color: white !important; }
body.home-active .submenu-arrow { color: rgba(255,255,255,0.6) !important; }
body.home-active .dev-badge { background: rgba(255,152,0,0.8) !important; }
body.home-active .menu-weather-section { background: rgba(255,255,255,0.08) !important; border-bottom-color: rgba(255,255,255,0.1) !important; }
body.home-active .menu-weather-section * { color: rgba(255,255,255,0.9) !important; }

/* 思源黑體 - 首頁全面使用 */
.home-slide, .home-slide *,
.home-hero-title,
.home-verse-area, .home-verse-area *,
.home-pinch-transition {
    font-family: "Noto Sans KR", "Noto Sans TC",
        "Apple SD Gothic Neo", "Malgun Gothic", "Microsoft JhengHei",
...
.home-hero-image .daily-verse-bg {
    position: absolute;
    top: 0; left: 0;
    width: 100%; height: 100%;
    background-image: url('bible-bg.avif');
    background-size: cover;
    background-position: center;
}

.home-hero-image .daily-verse-overlay {
    position: absolute;
    top: 0; left: 0;
    width: 100%; height: 100%;
...
.home-slide-1.loaded .home-hero-title {
    opacity: 1;
}
...
.home-verse-area {
    ...
    align-items: center;
    padding: clamp(20px, 3vh, 40px) clamp(20px, 5vw, 40px);
    opacity: 1;
    transform: translateX(0);
    transition: opacity 0.8s ease, transform 0.8s ease;
}

.home-slide-1.verse-show .home-verse-area {
    opacity: 1;
    transform: translateX(0);
}
...
.verse-hanging-card {
    position: relative;
    background: #faf8f4;
    padding: clamp(24px, 4vw, 36px) clamp(22px, 4vw, 34px) clamp(20px, 3vw, 28px);
...
.verse-clip {
    ...
    width: 22px;
    height: 30px;
    border: 2px solid rgba(90,139,96,0.35);
...
.verse-clip::after {
    ...
    width: 13px;
    height: 2px;
    background: rgba(90,139,96,0.35);
}
...
.home-feature:hover .home-feature-img img {
...
.home-feature {
    opacity: 0;
    transition: opacity 0.8s ease, transform 0.8s ease, filter 0.3s;
}

/* 圖左文右 → 從左邊滑入 */
.home-feature:not(.reverse) {
...
.home-pinch-transition::before {
    ...
    background: linear-gradient(to bottom, 
        transparent 0%, 
        rgba(180,170,150,0.3) 30%, 
        rgba(180,170,150,0.5) 50%, 
        rgba(180,170,150,0.3) 70%, 
        transparent 100%
    );
}

.home-pinch-transition .pinch-ornament {
    width: clamp(8px, 1.5vw, 12px);
    height: clamp(8px, 1.5vw, 12px);
    border: 1.5px solid rgba(180,170,150,0.5);
...
.home-feature-title {
    font-family: "Noto Sans KR", "Noto Sans TC",
        "Apple SD Gothic Neo", "Malgun Gothic", "Microsoft JhengHei", -apple-system, sans-serif;
...
.home-copyright-section {
    width: 100%;
    padding: clamp(20px, 3vh, 35px) 20px;
    text-align: center;
    background-color: #f5f0e8;
}
...
/* 選單內天氣區塊 */
.menu-weather-section {
    padding: 15px;
    background: linear-gradient(135deg, rgba(67, 160, 71, 0.1) 0%, rgba(139, 195, 74, 0.1) 100%);
...
.backend-toolbar {
    ...
    margin-bottom: 15px; padding: 10px; background: var(--card-bg); border-radius: 8px; flex-wrap: wrap; gap: 10px;
    min-height: 50px; border: 1px solid var(--border-lightest);
}
...
.stat-divider { margin: 0 8px; color: var(--border-light); }
...
.grid-row {
    display: grid;
    grid-template-columns: 0px 40px 0.8fr 0.6fr 1fr 1fr 0px; 
    align-items: center; padding: 15px; transition: all 0.3s ease;
}
.list-container.edit-mode .grid-row {
    grid-template-columns: 40px 40px 0.8fr 0.6fr 1fr 1fr 40px; 
}
...
.user-card { border: 1px solid var(--border-lightest); border-top: none; background: var(--card-bg); }
.user-card:last-child { border-radius: 0 0 8px 8px; }

.user-summary { cursor: pointer; font-size: 1rem; -webkit-tap-highlight-color: transparent; }
@media (hover: hover) {
    .user-summary:hover { background: #f9fbe7; }
}
.user-summary.expanded { background: #f1f8e9; border-bottom: 1px solid #e0e0e0; }

.user-details { display: none; background: var(--card-bg); }
.user-details.show { display: block; }

.detail-row { border-bottom: 1px solid var(--border-lightest); background: var(--card-bg); color: #555; font-size: 1rem; -webkit-tap-highlight-color: transparent; }
.detail-row:last-child { border-bottom: none; }

/* detail-row 專用grid佈局，對齊user-summary的狀態欄位 */
.detail-row.grid-row {
    grid-template-columns: 0px 40px 0.8fr 0.6fr 2fr 0px;
}
.list-container.edit-mode .detail-row.grid-row {
    grid-template-columns: 40px 40px 0.8fr 0.6fr 2fr 40px;
}
...
.list-container.edit-mode .editable { 
    cursor: pointer; border: 1px dashed #ccc; border-radius: 4px; padding: 2px 4px; background: var(--card-bg);
}
...
/* 需確認訊息用橙色 */
#confirmPointsSection {
    background: #fff8e1;
    border-color: #ffe082;
}

#confirmPointsSection .message-points-title {
    color: #e65100;
}

#confirmPointsSection .message-points-add-btn {
    background: #ff9800;
}

#confirmPointsSection .message-points-add-btn:hover {
    background: #e65100;
}

.message-points-header {
    display: flex;
    align-items: center;
    justify-content: space-between;
    margin-bottom: 12px;
...
@media (max-width: 700px) {
    ...
    .detail-row.grid-row > div:not(.check-cell):not(.action-cell),
    .detail-row.offline-grid-row > div:not(.check-cell):not(.action-cell) {
        width: 100%;
    }
...
.bible-chapters-container {
    ...
    padding: 15px;
    margin-bottom: 0;
    box-shadow: 0 10px 28px rgba(80, 60, 40, 0.16);
    backdrop-filter: blur(14px) saturate(1.2);
    -webkit-backdrop-filter: blur(14px) saturate(1.2);
    max-height: min(62vh, 440px);
    overflow-y: auto;
    z-index: 260;
    animation: chapterPopoverIn 0.18s ease;
}
...
.bible-chapters-container::before {
    content: "";
    position: absolute;
    top: -8px;
    left: 50%;
    ...
    height: 14px;
    background: rgba(236, 231, 223, 0.96);
    border-left: 1px solid rgba(67, 160, 71, 0.2);
    border-top: 1px solid rgba(67, 160, 71, 0.2);
    transform: translateX(-50%) rotate(45deg);
}

.bible-chapters-container.above-anchor::before {
    top: auto;
    bottom: -8px;
    border: none;
    border-right: 1px solid rgba(67, 160, 71, 0.2);
    border-bottom: 1px solid rgba(67, 160, 71, 0.2);
}

@keyframes chapterPopoverIn {
...
/* 首頁時回頂按鈕半透明 */
body.home-active .scroll-top-btn {
...
.bible-fab-main.active { background: rgba(56, 142, 60, 0.9); }
...
.bible-fab-copy {
    ...
    transition: all 0.3s;
    backdrop-filter: blur(5px);
    animation: fabCopyPulse 0.5s ease;
}
...
.bible-fab-copy:hover {
    background: var(--light-green-bg);
    transform: scale(1.1);
}

@keyframes fabCopyPulse {
...
/* 返回頂部按鈕也透明化 */
.scroll-top-btn {
    background: rgba(67, 160, 71, 0.92) !important;
    backdrop-filter: blur(10px);
    -webkit-backdrop-filter: blur(10px);
}
...
.copy-mode-selected-count {
    font-weight: 600;
}

/* 範圍輸入 */
.copy-mode-range-inputs {
    display: flex;
    align-items: center;
    gap: 8px;
    margin-bottom: 12px;
...
.copy-mode-btn.primary {
    background: var(--primary-green);
    color: white;
}

.copy-mode-btn.primary:hover {
    background: var(--dark-green);
}

.copy-mode-btn.secondary {
    background: var(--bg-secondary);
    color: #333;
}

.copy-mode-btn.secondary:hover {
    background: var(--border-lightest);
}

.copy-mode-btn:disabled {
    opacity: 0.5;
    cursor: not-allowed;
}

/* 語言勾選 */
.copy-mode-lang-options {
    display: flex;
    gap: 15px;
    padding: 12px;
    background: var(--bg-secondary);
...
.copy-mode-lang-option input[type="checkbox"] {
    width: 18px;
    height: 18px;
...
.bible-search-overlay.show { display: block; }
...
.bible-search-input-wrap:focus-within {
    border-color: var(--primary-green);
...
.bible-search-input::placeholder { color: #bbb; }
...
.bible-search-clear.show { display: flex; }
.bible-search-clear:hover { color: #888; }
...
/* 結果分組 */
.bible-search-results { padding-bottom: 12px; }

.bible-search-result-group {
    margin: 0;
}

.bible-search-result-group-title {
    font-size: 0.72rem;
    font-weight: 700;
    color: #aaa;
    letter-spacing: 0.5px;
...
.bible-search-result-item:hover { background: rgba(67,160,71,0.06); }
.bible-search-result-item:active { background: rgba(67,160,71,0.12); }
...
.smart-copy-input:focus {
    border-color: var(--primary-green);
}

.smart-copy-input::placeholder {
    color: var(--text-muted);
    font-size: 12px;
}
...
.smart-copy-btn:hover { filter: brightness(1.1); }
.smart-copy-btn:disabled { opacity: 0.5; cursor: not-allowed; }
.smart-copy-btn.loading { position: relative; color: transparent; }
.smart-copy-btn.loading::after {
    content: '';
    position: absolute;
    top: 50%; left: 50%;
...
.smart-copy-result.show { display: block; }
.smart-copy-result.success {
    background: rgba(67,160,71,0.1);
    color: var(--dark-green);
    border: 1px solid rgba(67,160,71,0.2);
}
.smart-copy-result.error {
...
.ai-analyzing-text {
    background: linear-gradient(
        90deg,
        var(--text-primary, #333) 0%,
        var(--text-primary, #333) 40%,
        #43a047 45%,
        #66bb6a 50%,
        #43a047 55%,
        var(--text-primary, #333) 60%,
        var(--text-primary, #333) 100%
    );
    background-size: 200% 100%;
    -webkit-background-clip: text;
    background-clip: text;
    -webkit-text-fill-color: transparent;
    animation: aiTextShimmer 1.5s ease-in-out infinite;
}
...
.ai-analyzing-btn {
    ...
    animation: aiButtonPulse 0.8s ease-in-out infinite;
}
...
.delete-options-overlay.show .delete-options-modal {
    transform: scale(1);
}
...
.delete-option-item input[type="checkbox"] {
    width: 18px;
    height: 18px;
    margin-right: 12px;
    accent-color: #c62828;
...
.delete-options-btn.confirm {
    background: #c62828;
    color: white;
}

.delete-options-btn.confirm:hover {
    background: #b71c1c;
}
...
.faith-auto-card:hover {
    border-color: var(--primary-green);
    box-shadow: 0 4px 15px rgba(67, 160, 71, 0.15);
    transform: translateY(-2px);
}
.faith-auto-card-icon {
    font-size: 2rem;
    margin-bottom: 10px;
    color: var(--primary-green);
}
.faith-auto-card-title {
    font-weight: 700;
    font-size: 1.05rem;
    color: var(--text-primary);
    margin-bottom: 6px;
}
.faith-auto-card-desc {
    font-size: 0.85rem;
    color: var(--text-muted);
    line-height: 1.5;
}
...
.ai-compose-step-label {
    font-weight: 600;
    color: var(--dark-green);
    font-size: 0.9rem;
    margin-bottom: 10px;
}
.ai-compose-input-row {
    display: flex;
    align-items: center;
    gap: 12px;
}
.ai-compose-input-row input {
...
.ai-compose-action-btn.copy {
    background: var(--primary-green);
    color: white;
}
.ai-compose-action-btn.retry {
    background: var(--bg-secondary);
    color: var(--text-secondary);
    border: 1px solid var(--border-lighter);
}
.ai-compose-action-btn:hover { filter: brightness(1.1); }

@media (max-width: 700px) {
    .ai-compose-container { max-width: 100%; }
    .ai-compose-input-row input { width: 80px !important; }
}

/* AI Panel compose link button (紫色保留) */
.ai-panel-compose-link {
    display: block;
    width: 100%;
    margin-top: 8px;
    padding: 8px;
    background: linear-gradient(135deg, #7c4dff22, #448aff22);
...
.ai-panel-compose-link:hover {
    background: linear-gradient(135deg, #7c4dff33, #448aff33);
}
